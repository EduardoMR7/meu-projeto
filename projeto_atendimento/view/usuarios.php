...
<head>
    ...
    <style>
        body {
            background-image: url('https://cdna.artstation.com/p/assets/images/images/060/777/480/original/retrieveraki-ttt.gif?1679317019');
...
<body>
    <div class="container">
        <h1 class="bg-info-subtle text-center p-2">LISTA DE USUÁRIO</h1>
        <section class="p-2">
